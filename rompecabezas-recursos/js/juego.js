...
var instrucciones = ["Utilizá las flechas de tu teclado para moverte por el tablero",
                     "Dirigite a la pieza que quieras intercambiar",
                     "El espacio vacío es para que puedas mover las piezas",
                    //  "Acá abajo podes ver cómo tiene que quedar la imagen",
                     "¡Suerte!"];
...
function mostrarCartelGanador() {
  swal({
     title: "¡Ganaste!",
    text: "Wes Anderson está orgulloso de vos ;)",
    icon: "success",
     button: "¿Jugamos otra vez?",
   });
}
